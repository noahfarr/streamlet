...
class SoftQLambda:
    ...
    def __post_init__(self):
        ...
        assert isinstance(action_space, Discrete), (
            "SoftQLambda requires a discrete action space, got "
    ...
    def init(self, key: Key) -> SoftQLambdaState:
    ...
    def train(
        self, key: Key, state: SoftQLambdaState, num_steps: int
    ) -> SoftQLambdaState:
        def step(state, key):
